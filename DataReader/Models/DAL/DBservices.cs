...
public class DBservices
{
    ...
    public List<Movie> getMoviesByActor(string actor)
    {
        ...
        try
        {
            ...
            String selectSTR = "SELECT * FROM cars_2020 where year = " + year.ToString();
            ...
            {   // Read till the end of the data into a row
                ...
                c.Manufacturer = (string)dr["manufacturer"];
                c.Price = Convert.ToDouble(dr["price"]);
                c.Model = (string)dr["model"];
                c.Year = Convert.ToInt32(dr["year"]);
                carList.Add(c);
            }
